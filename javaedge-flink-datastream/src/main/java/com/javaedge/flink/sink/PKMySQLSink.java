package com.javaedge.flink.sink;

import com.javaedge.flink.utils.MySQLUtils;
 ...
 * domain traffic
 */
public class JavaEdgeMySQLSink extends RichSinkFunction<Tuple2<String, Double>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        insertPstmt = connection.prepareStatement("insert into JavaEdge_traffic(domain,traffic) values (?,?)");
        updatePstmt = connection.prepareStatement("update JavaEdge_traffic set traffic=? where domain=?");
