package com.javaedge.flink.source;

import com.javaedge.flink.transformation.Access;
...
//        test04(env);
    ...
    public static void test05(StreamExecutionEnvironment env) {
        ...
        DataStream<String> stream = env.addSource(new FlinkKafkaConsumer<>("flinktopic", new SimpleStringSchema(), properties));
...
//        StreamExecutionEnvironment.createRemoteEnvironment()
        ...
        // 接收socket过来的数据，一行一个单词， 把JavaEdge的过滤掉
