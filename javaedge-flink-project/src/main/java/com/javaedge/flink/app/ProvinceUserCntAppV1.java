...
public class ProvinceUserCntAppV1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple3<String, Integer, Integer>> result = cleanStream.map((MapFunction<Access, Tuple3<String, Integer, Integer>>) value -> Tuple3.of(value.province, value.nu, 1)).keyBy((KeySelector<Tuple3<String, Integer, Integer>, Tuple2<String, Integer>>) value -> Tuple2.of(value.f0, value.f1)).sum(2);//.print("省份维度统计新老用户:").setParallelism(1);
